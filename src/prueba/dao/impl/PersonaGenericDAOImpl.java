...
import prueba.dao.PersonaGenericDAO;
 ...
 * 
 */
public class PersonaGenericDAOImpl<T, PK extends Serializable> implements PersonaGenericDAO<T, PK> {

	@PersistenceContext(unitName="PruebaConexionPU")
